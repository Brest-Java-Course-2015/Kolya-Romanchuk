INSERT INTO transaction (id_transaction, checknumbersender, checknumberrecipient, summa, date ,id_check) VALUES (1,2345,2347,2000, TO_TIMESTAMP('14/10/2015 20:30:00', 'DD/MM/YYYY HH:MI:SS'),2);
INSERT INTO transaction (id_transaction, checknumbersender, checknumberrecipient, summa, date ,id_check) VALUES (2,2346,2349,4542, TO_TIMESTAMP('14/10/2015 20:30:00', 'DD/MM/YYYY HH:MI:SS'),2);
