...
INSERT INTO check (id_check, checknumber, summa, id_user) VALUES (2, 121234, 321331, 2);
...
INSERT INTO user(id_user, login, password, role, firstname, lastname) VALUES (3,'admin','admin', 'ROLE_ADMIN','firstname1','lastname1');
INSERT INTO user(id_user, login, password, role, firstname, lastname) VALUES (4,'user','user', 'ROLE_USER','firstname1','lastname1');